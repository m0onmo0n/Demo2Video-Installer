    ...
    while True:
        try:
            ...
            try:
                ...
                # UPDATED: Use the process monitoring function instead of visual detection.
                ...
                if workflow_successful:
                    ...
                    try:
                        ...
                        video_title = f"Suspected Cheeter: {suspect_steam_id} - Highlights"
